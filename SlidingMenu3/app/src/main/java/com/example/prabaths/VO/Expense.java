...
public class Expense {
    ...
    public Expense(int carID, double cost, Date date, int id, String location, String notes, double odometerReading, int partialTank, int type, double unitPrice, String userID, double volume) {
        this.carID = carID;
        this.cost = cost;
        this.date = date;
        this.id = id;
