...
public class InsertToDB {
    ...
    Context context;
    String insertFuelExpenseUrl = "http://travelbuddy.netai.net/insertFuelExpense.php";
    String insertOtherExpenseUrl="http://travelbuddy.netai.net/insertOtherExpense.php";
    SQLiteHelper helper;
    ...
    public void insertFuelExpenseReport(final FuelExpense fuelExpense){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, insertFuelExpenseUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(context,"Fuel expense record added to the remote database successfully!!!",Toast.LENGTH_LONG).show();
            }
    ...
    public void insertOtherExpense(final OtherExpense otherExpense){
        StringRequest request = new StringRequest(Request.Method.POST, insertOtherExpenseUrl, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(context,"Other expense record added to the remote database successfully!!!",Toast.LENGTH_LONG).show();
